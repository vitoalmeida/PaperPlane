...
function RegisterScreen({ navigation }) {
  ...
  const [offsetImage] = useState(new Animated.ValueXY({ x: 0, y: 0 }))
  const [background] = useState(new Animated.ValueXY({ x: 0, y: 0 }))
